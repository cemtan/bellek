...
class MainWindow(QMainWindow):
    ...
    def create_info_panel(self):
        ...
        btn1.setFixedHeight(54)
        v = QVBoxLayout(btn1)
        v.setSpacing(0)
        v.setContentsMargins(4, 4, 4, 4)
        lbl = QLabel("▶")
        lbl.setAlignment(Qt.AlignCenter)
        lbl.setStyleSheet("font-size: 20px; margin-bottom: 4px;")
        ...
        btn4 = QWidget()
        btn4.setMinimumHeight(54)
        btn4.setMaximumHeight(54)
        v = QVBoxLayout(btn4)
        v.setSpacing(0)
        v.setContentsMargins(4, 4, 4, 4)
        lbl = QLabel("▦")
